...
trait Event {
    ...
    abstract boolean getArchivable() // Original: public boolean com.hubitat.hub.domain.Event.getArchivable()
    abstract boolean getDisplayed() // Original: public boolean com.hubitat.hub.domain.Event.getDisplayed()
    abstract java.lang.Long getInstalledAppId() // Original: public java.lang.Long com.hubitat.hub.domain.Event.getInstalledAppId()
    abstract java.lang.String getLinkText() // Original: public java.lang.String com.hubitat.hub.domain.Event.getLinkText()
    abstract boolean getTranslatable() // Original: public boolean com.hubitat.hub.domain.Event.getTranslatable()
    abstract java.lang.String getType() // Original: public java.lang.String com.hubitat.hub.domain.Event.getType()
    abstract long getUnixTime() // Original: public long com.hubitat.hub.domain.Event.getUnixTime()
    abstract boolean isArchivable() // Original: public boolean com.hubitat.hub.domain.Event.isArchivable()
    abstract boolean isDisplayed() // Original: public boolean com.hubitat.hub.domain.Event.isDisplayed()
    abstract boolean isTranslatable() // Original: public boolean com.hubitat.hub.domain.Event.isTranslatable()
    abstract me.biocomp.hubitat_ci.api.common_api.Event populateValues(java.util.Map a) // Original: public com.hubitat.hub.domain.Event com.hubitat.hub.domain.Event.populateValues(java.util.Map)
    abstract void setArchivable(boolean a) // Original: public void com.hubitat.hub.domain.Event.setArchivable(boolean)
    abstract void setData(java.lang.String a) // Original: public void com.hubitat.hub.domain.Event.setData(java.lang.String)
    abstract void setDate(java.util.Date a) // Original: public void com.hubitat.hub.domain.Event.setDate(java.util.Date)
    abstract void setDescription(java.lang.String a) // Original: public void com.hubitat.hub.domain.Event.setDescription(java.lang.String)
    abstract void setDescriptionText(java.lang.String a) // Original: public void com.hubitat.hub.domain.Event.setDescriptionText(java.lang.String)
    abstract void setDevice(me.biocomp.hubitat_ci.api.common_api.DeviceWrapper a) // Original: public void com.hubitat.hub.domain.Event.setDevice(com.hubitat.app.DeviceWrapper)
    abstract void setDeviceId(java.lang.Long a) // Original: public void com.hubitat.hub.domain.Event.setDeviceId(java.lang.Long)
    abstract void setDisplayName(java.lang.String a) // Original: public void com.hubitat.hub.domain.Event.setDisplayName(java.lang.String)
    abstract void setDisplayed(boolean a) // Original: public void com.hubitat.hub.domain.Event.setDisplayed(boolean)
    abstract void setHubId(java.lang.Long a) // Original: public void com.hubitat.hub.domain.Event.setHubId(java.lang.Long)
    abstract void setId(java.lang.Long a) // Original: public void com.hubitat.hub.domain.Event.setId(java.lang.Long)
    abstract void setInstalledAppId(java.lang.Long a) // Original: public void com.hubitat.hub.domain.Event.setInstalledAppId(java.lang.Long)
    abstract void setIsStateChange(java.lang.Boolean a) // Original: public void com.hubitat.hub.domain.Event.setIsStateChange(java.lang.Boolean)
    abstract void setLinkText(java.lang.String a) // Original: public void com.hubitat.hub.domain.Event.setLinkText(java.lang.String)
    abstract void setLocation(me.biocomp.hubitat_ci.api.common_api.Location a) // Original: public void com.hubitat.hub.domain.Event.setLocation(com.hubitat.hub.domain.Location)
    abstract void setLocationId(java.lang.Long a) // Original: public void com.hubitat.hub.domain.Event.setLocationId(java.lang.Long)
    abstract void setName(java.lang.String a) // Original: public void com.hubitat.hub.domain.Event.setName(java.lang.String)
    abstract void setSource(java.lang.String a) // Original: public void com.hubitat.hub.domain.Event.setSource(java.lang.String)
    abstract void setTranslatable(boolean a) // Original: public void com.hubitat.hub.domain.Event.setTranslatable(boolean)
    abstract void setType(java.lang.String a) // Original: public void com.hubitat.hub.domain.Event.setType(java.lang.String)
    abstract void setUnit(java.lang.String a) // Original: public void com.hubitat.hub.domain.Event.setUnit(java.lang.String)
    abstract void setValue(java.lang.String a) // Original: public void com.hubitat.hub.domain.Event.setValue(java.lang.String)
    abstract java.lang.String toJson() // Original: public java.lang.String com.hubitat.hub.domain.Event.toJson()
    abstract java.util.Map toMap() // Original: public java.util.Map com.hubitat.hub.domain.Event.toMap()
}
