        ...
        BaseExecutorApi
{
     ...
     */
    abstract def page(String name, String title, Closure makeContents = null)
     ...
     */
    abstract def page(Map options, Closure makeContents)

    /**
     * Adds section to a page
     */
    abstract def section(String sectionTitle = null, Closure makeContents)
     ...
     */
    abstract def section(String sectionTitle, Map options, Closure makeContents)
     ...
     */
    abstract def preferences(Map options = null, Closure makeContents)
